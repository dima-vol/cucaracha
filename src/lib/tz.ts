...
/** Classify a local 0..23 hour into day/evening/night tiers for bar styling. */
export function hourTier(hour24: number): "day" | "evening" | "night" {
  // 6am..6pm day; 6pm..10pm evening; 10pm..6am night
  if (hour24 >= 6 && hour24 < 18) return "day";
